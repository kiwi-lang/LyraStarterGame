...
def getloc(default="E:/Examples/LyraStarterGame"):
    return os.getenv("PluginBasePath", default)
...
gamefeature = "E:/Examples/LyraStarterGame/Plugins/GameFeatures/"
projects = {
    "LyraStarterGame": plugin("LyraStarterGame", os.path.join(project_root, "..")),
    "AsyncMixin": plugin("AsyncMixin"),
    "CommonUser": plugin("CommonUser"),
    "GameSettings": plugin("GameSettings"),
    "UIExtension": plugin("UIExtension"),
    "CommonGame": plugin("CommonGame"),
    "GameSubtitles": plugin("GameSubtitles"),
    "ModularGameplayActors": plugin("ModularGameplayActors"),
    "CommonLoadingScreen": plugin("CommonLoadingScreen"),
    "GameplayMessageRouter": plugin("GameplayMessageRouter"),
    "PocketWorlds": plugin("PocketWorlds"),
    "LyraExampleContent": plugin("LyraExampleContent"),
    "LyraExtTool": plugin("LyraExtTool"),
    "ShooterCore": plugin("ShooterCore", gamefeature),
    "ShooterExplorer": plugin("ShooterExplorer", gamefeature),
    "ShooterMaps": plugin("ShooterMaps", gamefeature),
    "ShooterTests": plugin("ShooterTests", gamefeature),
    "TopDownArena": plugin("TopDownArena", gamefeature),
}
...
breathe_default_project = "LyraStarterGame"
breathe_projects = {
...
exhale_args = {
    ...
    "rootFileName": "LyraAPI.rst",
    "rootFileTitle": "Lyra API",
